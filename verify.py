...
TARGETS: list[Target] = [
    ...
    Target(
        name="check_stop_buggy",
        entry="check_stop_buggy.py",
        expected="FAILED",
        safety_expected=None,
    ),
    Target(
        name="scheduler_token_budget",
        entry="scheduler_token_budget.py",
        expected="SUCCESSFUL",
        safety_expected="SUCCESSFUL",
    ),
    Target(
        name="scheduler_token_budget_buggy",
        entry="scheduler_token_budget_buggy.py",
        expected="FAILED",
        safety_expected=None,
    ),
    Target(
    ...
    Target(
        name="scheduler_token_budget_preempt",
        entry="scheduler_token_budget_preempt.py",
        esbmc_args=("--unwind", "5"),
        expected="SUCCESSFUL",
        safety_expected="SUCCESSFUL",
    ),
    Target(
        name="scheduler_token_budget_preempt_buggy",
        entry="scheduler_token_budget_preempt_buggy.py",
        esbmc_args=("--unwind", "5"),
        expected="FAILED",
        safety_expected=None,
    ),
