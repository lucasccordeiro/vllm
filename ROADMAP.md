...
|---|---|---|---|
| End of Tier 1 + both Tier 2 audits + four Tier 2 harnesses (current) | 16 entries | ~74 s | **4** (filed: #43496 + #43521 + #43532; queued: `--hash-block-size -k` propagation as comment for #43521) |
